        ...
        <table border="1" width="100%" class="table table-hover">
            ...
            while ($data = mysqli_fetch_array($query)) {
                ...
                <tr>
                    ...
                    <td class="text-center"><a href="pembayaran-edit.php?id_pembayaran=<?= $data['id_pembayaran']; ?>" class="btn btn-warning">Edit</a><br><br><a href="pembayaran-hapus.php?id_pembayaran=<?= $data['id_pembayaran']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')" class="btn btn-danger">Hapus</a><br><br><a href="pembayaran-cetak.php?id_pembayaran=<?= $data['id_pembayaran']; ?>" class="btn btn-info" id="tombol" target="_blank">Cetak</a></td>
                </tr>
                <?php
            } ?>
        </table>
